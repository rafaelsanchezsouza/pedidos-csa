...
APP_DIR="/opt/pedidos-app"
NGINX_CONF="/etc/nginx/sites-available/pedidos-app"
...
sudo ln -sf "$NGINX_CONF" /etc/nginx/sites-enabled/pedidos-app
sudo nginx -t
