...
| 3 | Cadastrar catálogo real do primeiro cliente | define `type` fixo/extra de cada item |
| 4 | ~~Generalizar vocabulário de UI~~ | ✅ feito — membro→cliente, produtor→fornecedor, colmeia→tenant/organização |
