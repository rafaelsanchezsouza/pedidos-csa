...
describe('resolveFrete', () => {
  it('usa o padrão da tenant quando o membro não tem override', () => {
    expect(resolveFrete({}, { freteDelivery: 12 })).toBe(12)
  })

  it('override do membro vence o padrão da tenant', () => {
  ...
  it('override 0 (entrega grátis) vence o padrão da tenant', () => {
  ...
  it('padrão 0 na tenant é respeitado', () => {
