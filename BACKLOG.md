...
| # | Item | Issue |
|---|------|-------|
| 1 | Ciclo quinzenal escondido no bottom da tela, impossível de selecionar (mobile e desktop) | #44 |
| 2 | Dias de entrega da cesta: semana marcada errada gerando cobrança a mais | #43 |

Os dois são bloqueadores: o 1 impede o quinzenal de usar o app, o 2 gera erro de dinheiro.
Suspeita: mesma raiz — lógica de ciclo quinzenal. Investigar juntos antes de separar.
...
- #43 é bug de dados de um membro ou da lógica de ciclo? Já reproduzido?
